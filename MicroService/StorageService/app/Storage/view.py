    ...
    try:
        ...
        if(ps_connection):
            ...
            query = (" select system_create_limit_storage from system_create_limit "
                                ...
                                " on system_group_all.system_group_all_id = system_create_limit.system_create_limit_id "
                                ...
                                " inner join company"
                                " on "
                                " company.company_id = company_has_system_group_all.company_id  where company.company_public_id = %s ")
